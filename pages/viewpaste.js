...
var author$project$ViewPaste$Paste = F3(
	function (lines, comments, id) {
		return {comments: comments, id: id, lines: lines};
	});
var author$project$ViewPaste$Comment = function (body) {
	return {body: body};
};
...
var author$project$ViewPaste$commentDecoder = A2(
	elm$json$Json$Decode$map,
	author$project$ViewPaste$Comment,
	A2(elm$json$Json$Decode$field, 'body', elm$json$Json$Decode$string));
var author$project$ViewPaste$LineWithComments = F2(
	function (line, lineComments) {
		return {line: line, lineComments: lineComments};
	});
var elm$json$Json$Decode$list = _Json_decodeList;
var elm$json$Json$Decode$map2 = _Json_map2;
var author$project$ViewPaste$lineDecoder = A3(
	elm$json$Json$Decode$map2,
	author$project$ViewPaste$LineWithComments,
...
var author$project$ViewPaste$pasteDecoder = A4(
	elm$json$Json$Decode$map3,
	author$project$ViewPaste$Paste,
	A2(
		elm$json$Json$Decode$field,
		'lines',
		elm$json$Json$Decode$list(author$project$ViewPaste$lineDecoder)),
	A2(
		elm$json$Json$Decode$field,
		'comments',
		elm$json$Json$Decode$list(author$project$ViewPaste$commentDecoder)),
...
var author$project$ViewPaste$getPasteFromServer = function (pasteId) {
	return elm$http$Http$get(
		{
			expect: A2(elm$http$Http$expectJson, author$project$ViewPaste$GotPaste, author$project$ViewPaste$pasteDecoder),
...
var author$project$ViewPaste$getPasteIdFromUrl = function (url) {
	return A2(
		elm$core$String$dropLeft,
		4,
		A2(elm$core$Maybe$withDefault, 'failedToParseQuery', url.query));
};
var author$project$ViewPaste$init = F3(
	function (_n0, url, _n1) {
		return _Utils_Tuple2(
			author$project$ViewPaste$Loading,
			author$project$ViewPaste$getPasteFromServer(
				author$project$ViewPaste$getPasteIdFromUrl(url)));
	});
...
var author$project$ViewPaste$onUrlChange = function (url) {
...
var author$project$ViewPaste$Failure = function (a) {
	return {$: 'Failure', a: a};
};
